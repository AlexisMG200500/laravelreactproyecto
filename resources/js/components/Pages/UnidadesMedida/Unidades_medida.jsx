...
import {API_UNIDADES_MEDIDAS as API_URL, METODO_LISTAR, METODO_CREAR, METODO_EDITAR, METODO_BORRAR, CREAR, EDITAR} from '../../Constantes';
...
export default function Unidades_medida(props) {
    ...
    const estatusLista = useFetch(url_lista, opcionesListar, METODO_LISTAR, true);
    const estatusCrear = useFetch(API_URL, opcionesCreacion, METODO_CREAR, detonarCreacion);
    const estatusEditar = useFetch(url_edicion, opcionesEdicion, METODO_EDITAR, detonarEdicion);
    const estatusBorrar = useFetch(url_borra, opcionesBorrado, METODO_BORRAR, detonarBorrado);
