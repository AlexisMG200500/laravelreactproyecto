...
export default function Lista(props) {
    return (
        <Table striped bordered hover size="sm">
            <thead>
                <tr>
                    <th style={{width:'70%'}}>Unidad de Medida</th>
...
function renglones({estatus, handleEdita, handleBorra}) {
    ...
    if (!estatus.result?.data || 1 > estatus.result.data.length) {
        return <tr><td colSpan="4" style={{textAlign:'center', fontWeight:'bold'}}>Sin unidades de medida</td></tr>
    }
